...
- See [Using Private Images]({{ site.baseurl }}/2.0/docker-authenticated-pulls/) for information about how to authorize your build to use an image in a private repository or in Amazon ECR.
